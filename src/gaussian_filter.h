...
#define MIN_SIGMA 0.5 // The initial (minimum) value of sigma, this is the first sigma value we will benchmark
#define MAX_SIGMA 2 // This is the maximum value of sigma that we want to benchmark to
#define SIGMA_STEP 0.5 // This is how much we want to increment sigma by each time we benchmark
