...
void process_sse_base(unsigned char* input, float* kernel, int x, int y, int width, int range, __m128* sum_red, __m128* sum_green, __m128* sum_blue, int is_vertical);
